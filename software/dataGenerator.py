...
header_content_template = """#ifndef NFC_MESSAGES_H
...
const uint8_t *nfcMessages[] = {{{1}}};

// Number of messages
const uint8_t messageNumber = {2};
...
if __name__ == "__main__":
    ...
    with open("nfc_messages.h", "w") as header_file:

        header_file.write(header_content_template.format(messages_multilinetext, name_of_messagearray, number_of_messages))
